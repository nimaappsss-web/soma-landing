    ...
    <footer className="w-full bg-soma-black rounded-[30px] mt-2 mb-[10px] px-[18px] md:px-[62px] py-8 md:py-10">
      <div className="flex flex-row items-center justify-between gap-6 mb-6">
        ...
        <div className="flex items-center gap-4 border border-white/15 rounded-[35px] px-[13px] py-[11px]">
          <Link href="https://facebook.com/checksomaapp" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/80 transition-colors">
            <Facebook variant="Bold" size={24} color="currentColor" />
          </Link>
          <Link href="https://x.com/checksomaapp" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/80 transition-colors">
            <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </Link>
          <Link href="https://instagram.com/checksomaapp" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/80 transition-colors">
