      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-[1.5] bg-soma-white-card rounded-[30px] pl-10 pt-[30px] relative overflow-hidden">
            ...
            <h3 className="text-[24px] font-semibold text-soma-black mb-1 leading-tight pr-4">
              Know every student, clearly.
            </h3>
            <p className="text-[14px] md:text-[16px] text-gray-4 leading-[1.5] md:leading-[1.6] pr-4 max-w-[406px]">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 bg-soma-white-card rounded-[30px] pl-10 pt-[30px] relative overflow-hidden">
            ...
            <p className="text-[14px] md:text-[16px] text-gray-4 leading-[1.5] md:leading-[1.6] pr-4 max-w-[406px] min-h-[77px]">
              Track attendance consistently, spot gaps early and give your team a
              clearer picture of what's happening across classes.
            </p>
            <div className="bg-soma-bg rounded-tl-[30px] right-0 w-full aspect-[4/3] overflow-hidden mt-10 pl-4.5 pt-4">
          ...
          <div className="flex-1 bg-soma-white-card rounded-[30px] pl-10 pt-[30px] relative overflow-hidden flex flex-col">
            ...
            <p className="text-[14px] md:text-[16px] text-gray-4 leading-[1.5] md:leading-[1.6] pr-4 max-w-[406px] line-clamp-3 min-h-[77px]">
